...
def test_physical_to_angular():
    ...
    angular = quantity_conversions.physical_to_angular(length, distance)
...
def test_round_trip():
    ...
    round_tripped = quantity_conversions.physical_to_angular(
        quantity_conversions.angular_to_physical(angle, distance), distance
    )
